...
call_user_func(function ($extKey = 'PREPARE_LOWERVENDOR_site') {
    ...
    if (file_exists(GeneralUtility::getFileAbsFileName('EXT:PREPARE_LOWERVENDOR_site/Configuration/TCA/Overrides/container.yaml'))) {
        $containersFromYaml = (new YamlFileLoader())->load(GeneralUtility::getFileAbsFileName('EXT:PREPARE_LOWERVENDOR_site/Configuration/TCA/Overrides/container.yaml'));
