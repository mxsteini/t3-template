...
export GITLAB_ARTIFACT_TOKEN=${GITLAB_ARTIFACT_TOKEN:-glpat-vbHCwKK3_cp4-re4PVyH}
...
#log.info "checking for realpath"
#silent_ssh "which realpath"
#
#if [ "$?" -ne 0 ]; then
#  log.error "##############################################################"
#  log.error "please install realpath"
#  exit 1
#fi
#
#log.info "looks good"
